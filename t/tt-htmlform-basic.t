...
is $initial_edit, '<form id="edit_class_Form" method="post" class="ernst_htmlform" action="ACTION"><ul><li><span id="view_id">ID: </span></li><li><label for="username" id="username_label">Desired username<span class="required">*</span></label><input type="text" class="ernst_field ernst_String" name="username" id="username" value="" /><p class="instruct">The username can contain any characters.  Choose wisely; you may not change it after registration.</p></li><li><div class="rich_text"><label for="biography" id="biography_label">Biography</label><input type="text" class="ernst_field ernst_String" name="biography" id="biography" value="" /></div></li><li><input type="submit" name="do_submit" value="Submit" /></li></ul> </form>', 
  'initial edit worked';

my $edit = $i->interpret($form, 'edit', { action => 'ACTION' });
is $edit, '<form id="edit_class_Form" method="post" class="ernst_htmlform" action="ACTION"><ul><li><span id="view_id">ID: 42</span></li><li><b>jrockway</b></li><li><div class="rich_text"><label for="biography" id="biography_label">Biography</label><input type="text" class="ernst_field ernst_String" name="biography" id="biography" value="&lt;OH HAI&gt;" /></div></li><li><input type="submit" name="do_submit" value="Submit" /></li></ul> </form>',
